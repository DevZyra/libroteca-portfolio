...
create table users (id bigint not null, email varchar(255), email_verification_status boolean, encrypted_password varchar(255), first_name varchar(255), last_name varchar(255), role varchar(255), user_id varchar(255), email_verification_token_id bigint, primary key (id));
